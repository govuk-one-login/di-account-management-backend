...
interface AwsSdkJestMockBaseMatchers<R> extends Record<string, any> {
     ...
     * @param input
     */
    toHaveReceivedNthSpecificCommandWith<TCmdInput extends object, TCmdOutput extends MetadataBearer>(call: number, command: new (input: TCmdInput) => AwsCommand<TCmdInput, TCmdOutput>, input: Partial<TCmdInput>): R;
}
interface AwsSdkJestMockAliasMatchers<R> {
     ...
     * @param input
     */
    toReceiveNthSpecificCommandWith<TCmdInput extends object, TCmdOutput extends MetadataBearer>(call: number, command: new (input: TCmdInput) => AwsCommand<TCmdInput, TCmdOutput>, input: Partial<TCmdInput>): R;
}
/**
