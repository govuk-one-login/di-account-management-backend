...
export interface Behavior<TInput extends object, TOutput extends MetadataBearer, TCommandOutput extends TOutput> {
     ...
     * @param strict Should the payload match strictly (default false, will match if all defined payload properties match)
     */
    on<TCmdInput extends TInput, TCmdOutput extends TOutput>(command: new (input: TCmdInput) => AwsCommand<TCmdInput, TCmdOutput>, input?: Partial<TCmdInput>, strict?: boolean): Behavior<TInput, TOutput, TCmdOutput>;
    /**
     ...
     * @param fn Function taking Command input and returning result
     */
    callsFakeOnce(fn: (input: any) => any): Behavior<TInput, TOutput, TCommandOutput>;
}
/**
...
export declare class AwsStub<TInput extends object, TOutput extends MetadataBearer> implements Behavior<TInput, TOutput, TOutput> {
    ...
    constructor(client: Client<TInput, TOutput, any>, send: SinonStub<[AwsCommand<TInput, TOutput>], Promise<TOutput>>);
...
export declare class CommandBehavior<TInput extends object, TOutput extends MetadataBearer, TCommandOutput extends TOutput> implements Behavior<TInput, TOutput, TCommandOutput> {
     ...
     */
    private nextChainableCallNumber;
...
export declare type AwsCommand<Input extends ClientInput, Output extends ClientOutput, ClientInput extends object = any, ClientOutput extends MetadataBearer = any> = Command<ClientInput, Input, ClientOutput, Output, any>;
