...
import { NodeDecryptionMaterial, NodeEncryptionMaterial, WebCryptoDecryptionMaterial, WebCryptoEncryptionMaterial } from './cryptographic_material';
...
export type EncryptionMaterial<Suite> = Suite extends NodeAlgorithmSuite ? NodeEncryptionMaterial : Suite extends WebCryptoAlgorithmSuite ? WebCryptoEncryptionMaterial : never;
export type DecryptionMaterial<Suite> = Suite extends NodeAlgorithmSuite ? NodeDecryptionMaterial : Suite extends WebCryptoAlgorithmSuite ? WebCryptoDecryptionMaterial : never;
