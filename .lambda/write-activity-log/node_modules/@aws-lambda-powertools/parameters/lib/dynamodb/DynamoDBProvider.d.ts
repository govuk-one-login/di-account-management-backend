...
import type { DynamoDBProviderOptions, DynamoDBGetOptions, DynamoDBGetMultipleOptions, DynamoDBGetOutput, DynamoDBGetMultipleOutput } from '../types/DynamoDBProvider';
 ...
 */
declare class DynamoDBProvider extends BaseProvider {
    client: DynamoDBClient;
    protected keyAttr: string;
    protected sortAttr: string;
    protected tableName: string;
    protected valueAttr: string;
    /**
     ...
     */
    get<ExplicitUserProvidedType = undefined, InferredFromOptionsType extends DynamoDBGetOptions | undefined = DynamoDBGetOptions>(name: string, options?: InferredFromOptionsType & DynamoDBGetOptions): Promise<DynamoDBGetOutput<ExplicitUserProvidedType, InferredFromOptionsType> | undefined>;
    /**
     ...
     * @see https://docs.powertools.aws.dev/lambda-typescript/latest/utilities/parameters/
     */
    getMultiple<ExplicitUserProvidedType = undefined, InferredFromOptionsType extends DynamoDBGetMultipleOptions | undefined = DynamoDBGetMultipleOptions>(path: string, options?: InferredFromOptionsType & DynamoDBGetMultipleOptions): Promise<DynamoDBGetMultipleOutput<ExplicitUserProvidedType, InferredFromOptionsType> | undefined>;
    /**
     ...
     */
    protected _get(name: string, options?: DynamoDBGetOptions): Promise<JSONValue | undefined>;
    /**
     ...
     */
    protected _getMultiple(path: string, options?: DynamoDBGetMultipleOptions): Promise<Record<string, JSONValue>>;
}
