...
import type { SecretsProviderOptions, SecretsGetOptions, SecretsGetOutput } from '../types/SecretsProvider';
/**
 * ## Intro
 ...
 */
declare class SecretsProvider extends BaseProvider {
     ...
     * @see https://docs.powertools.aws.dev/lambda-typescript/latest/utilities/parameters/
     */
    get<ExplicitUserProvidedType = undefined, InferredFromOptionsType extends SecretsGetOptions | undefined = SecretsGetOptions>(name: string, options?: InferredFromOptionsType & SecretsGetOptions): Promise<SecretsGetOutput<ExplicitUserProvidedType, InferredFromOptionsType> | undefined>;
    /**
     ...
     */
    protected _get(name: string, options?: SecretsGetOptions): Promise<string | Uint8Array | undefined>;
    /**
     * Retrieving multiple parameter values is not supported with AWS Secrets Manager.
     *
     * @throws Not Implemented Error.
     */
    protected _getMultiple(_path: string, _options?: unknown): Promise<void>;
}
