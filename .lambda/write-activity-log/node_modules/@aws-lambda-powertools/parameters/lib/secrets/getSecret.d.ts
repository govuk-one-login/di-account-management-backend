import type { SecretsGetOptions, SecretsGetOutput } from '../types/SecretsProvider';
/**
 * ## Intro
 ...
 */
declare const getSecret: <ExplicitUserProvidedType = undefined, InferredFromOptionsType extends SecretsGetOptions = SecretsGetOptions>(name: string, options?: (InferredFromOptionsType & SecretsGetOptions) | undefined) => Promise<SecretsGetOutput<ExplicitUserProvidedType, InferredFromOptionsType> | undefined>;
export { getSecret };
