 ...
 */
declare const getParameter: <ExplicitUserProvidedType = undefined, InferredFromOptionsType extends SSMGetOptions = SSMGetOptions>(name: string, options?: (InferredFromOptionsType & SSMGetOptions) | undefined) => Promise<SSMGetOutput<ExplicitUserProvidedType, InferredFromOptionsType> | undefined>;
export { getParameter };
