import type { SSMGetParametersByNameOptions, SSMGetParametersByNameOutput } from '../types/SSMProvider';
/**
 * ## Intro
 ...
 */
declare const getParametersByName: <ExplicitUserProvidedType = undefined>(parameters: Record<string, SSMGetParametersByNameOptions>, options?: SSMGetParametersByNameOptions) => Promise<SSMGetParametersByNameOutput<ExplicitUserProvidedType>>;
