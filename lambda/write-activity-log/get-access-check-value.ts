 ...
 */
export async function getHashedAccessCheckValue(secretId: string): Promise<string> {
  ...
  return crypto.createHash(SecretValueAlgorithm).update(accessCheckValue).digest(SecretValueEncoding);
}
