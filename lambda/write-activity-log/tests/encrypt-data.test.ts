...
const mockedSecretsManager = mockClient(SecretsManagerClient).on(GetSecretValueCommand);
...
describe('encryptData', () => {
  ...
  beforeEach(() => {
    ...
    process.env.GENERATOR_KEY_ARN = "arn:aws:kms:eu-west-2:111122223333:key/bc436485-5092-42b8-92a3-0aa8b93536dc";
  ...
  it('should return the encryption result Base64 encoded', async () => {
    ...
    const result = await encryptData(encryptDataInput.activityLogData, encryptDataInput.userId);
    ...
    expect(buildEncrypt().encrypt).toHaveBeenCalledWith(
      { generatorKeyId: 'arn:aws:kms:eu-west-2:111122223333:key/bc436485-5092-42b8-92a3-0aa8b93536dc' },  // incorrect
      'eyJhbGciOiJIUzI1NiIs9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6jM5M.SflKxwRJSMeKKF2QT4f_adQssw5c',
      {
        encryptionContext: {
          ...
          accessCheckValue: 'a393a60804eeb859d0f2d938c530b352b826583b9d648b95a8acdc6e75da85e4',
