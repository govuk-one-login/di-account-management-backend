 ...
 */
export declare const mockClient: <TInput extends object, TOutput extends MetadataBearer, TConfiguration>(client: InstanceOrClassType<Client<TInput, TOutput, TConfiguration>>) => AwsStub<TInput, TOutput, TConfiguration>;
type ClassType<T> = {
    prototype: T;
};
