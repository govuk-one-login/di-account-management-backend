...
import { TEST_ACTIVITY_LOG_ENTRY } from "./testFixtures.js";
...
describe("encryptData", () => {
  ...
  let encryptData: typeof import("../common/encrypt-data.js").encryptData;
  beforeAll(async () => {
    ...
    process.env.BACKUP_WRAPPING_KEY_ARN =
      "arn:aws:kms:eu-west-2:111122223333:key/49c5492b-b1bc-42a8-9a5c-b2015e810c1c";
    encryptData = (await import("../common/encrypt-data.js")).encryptData;
  });
  beforeEach(async () => {
