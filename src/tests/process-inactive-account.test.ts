...
vi.mock("../common/iadGuards/processGuards/hasAisBlockIntervention.js", () => ({
  hasAisBlockIntervention: mockHasAisBlockIntervention,
}));

vi.mock(
  "../common/iadGuards/processGuards/hasRecentActivityLogEntry.js",
  () => ({
...
vi.mock(
  "../common/iadGuards/processGuards/sendInactiveAccountEmailsIsDisabled.js",
  () => ({
    sendInactiveAccountEmailsIsDisabled:
      mockSendInactiveAccountEmailsIsDisabled,
  })
);

vi.mock("../common/iadGuards/processGuards/doesNotHaveEmailAddress.js", () => ({
